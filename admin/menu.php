...
$adminMenuItems = [
    ...
    ['promocoes', 'admin/promocoes/index.php', 'bi-megaphone', 'Promocoes'],
    ...
    ['relatorios', 'admin/relatorios/index.php', 'bi-graph-up', 'Relatorios'],
    ['perfis', 'admin/perfis/index.php', 'bi-shield-lock', 'Perfis'],
    ['gestores', 'admin/gestores/index.php', 'bi-person-gear', 'Gestores'],
    ['configuracoes', 'admin/configuracoes/index.php', 'bi-sliders', 'Configuracoes'],
];
?>
